...
const RecipePostForm = ({ recipe, postRecipe, removeImageUrl, navigation }) => {
	...
	const handleReset = () => {
		Alert.alert('Reset Form', "All of your changes will be discarded, are you sure you'd like to proceed?", [
			{
				text: 'Cancel'
			},
			{
		...
		return (
			<SafeAreaView style={defaultStyles.container}>
				<ScrollView ref={ref}>
					...
					{imageFieldWarning && (
						<Text style={[ defaultStyles.text, styles.warning ]}>Please Add an Image!</Text>
					)}
					<ImageInput />
					<View style={styles.recipeContent}>
						{/* Recipe Name: ________________________________________*/}
						{nameFieldWarning && (
							<Text style={[ defaultStyles.text, styles.warning ]}>Please Enter a Recipe Title!</Text>
						)}
						<TextInput
						...
						{timeFieldWarning && (
							<Text style={[ defaultStyles.text, styles.warning ]}>Please Enter a Cook Time!</Text>
						)}
						<TextInput
						...
						{ingredientsFieldWarning && (
							<Text style={[ defaultStyles.text, styles.warning ]}>No Ingredients!</Text>
						)}
						<View>
						...
						{directionsFieldWarning && (
							<Text style={[ defaultStyles.text, styles.warning ]}>No Directions!</Text>
						)}
						<View>
							<View style={styles.formInputView}>
								<TextInput
