...
import { FeedRecipesScreen, AllRecipesScreen } from '../screens/ExploreRecipesScreen';
...
const AllAndSingleRecipeStack = () => (
	<Stack.Navigator>
		...
		<Stack.Screen name="Recipe" component={RecipeScreen} options={{ ...headerStyle, headerShown: false }} />
		<Stack.Screen
...
const ProfileAndPostStack = () => (
	<Stack.Navigator>
		<Stack.Screen name="Profile" component={UserProfileScreen} options={{ ...headerStyle, headerShown: false }} />
		...
		drawerContent={(props) => {
			return (
				<DrawerContentScrollView {...props}>
					...
					<DrawerItem label="Logout (not functioning)" onPress={() => console.log('logout clicked')} />
...
const DirectMessageStack = () => (
	<Stack.Navigator>
		<Stack.Screen name="Messages" component={AllThreadsScreen} options={headerStyle} />
		<Stack.Screen name="Chat" component={SingleThreadScreen} options={headerStyle} />
	</Stack.Navigator>
);
...
export const TabNavigator = () => (
	...
	>
		...
		<Tab.Screen
			...
			options={{
				tabBarIcon: () => <FontAwesome name="search" size={33} color={colors.white} />
			}}
		/>
		<Tab.Screen
			name="New Recipe"
			...
			options={{
				tabBarIcon: () => <Entypo name="circle-with-plus" size={35} color={colors.white} />
			}}
		/>
		<Tab.Screen
			name="All Messages"
			...
			options={{
				tabBarIcon: () => <FontAwesome name="envelope" size={31} color={colors.white} />
				// tabBarBadge: 2,
			}}
		/>
		<Tab.Screen
			...
			options={{
				tabBarIcon: () => <FontAwesome name="user" size={36} color={colors.white} />
			}}
			// creates dev warning when already at base stack
			listeners={({ navigation }) => ({
				tabPress: () => {
